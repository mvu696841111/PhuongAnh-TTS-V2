...
from phuonganh_tts.core_xpu import XPUPhuongAnhTTS
from phuonganh_utils.core_utils import split_text_into_chunks, join_audio_chunks, env_bool
...
print("⏳ Đang khởi động phuonganh-tts (Phiên bản tối ưu cho Intel XPU)...")
...
with gr.Blocks(theme=theme, css=css, title="phuonganh-tts (XPU)", head=head_html) as demo:
...
<div class="header-box">
    <h1 class="header-title">
        ...
        <span class="gradient-text">phuonganh-tts Studio (Intel XPU Edition)</span>
    </h1>
    <div class="model-card-content">
        <div class="model-card-item">
            <strong>Models:</strong>
            <a href="https://huggingface.co/Nemmer/phuonganh-tts-v2" target="_blank" class="model-card-link">phuonganh-tts-v2</a>
        </div>
        <div class="model-card-item">
            <strong>Repository:</strong>
            <a href="https://github.com/mvu696841111/PhuongAnh-TTS" target="_blank" class="model-card-link">GitHub</a>
        </div>
        <div class="model-card-item">
        ...
        with gr.Group():
            ...
            with gr.Row(visible=False) as custom_model_group:
                custom_backbone_model_id = gr.Textbox(
                    ...
                    placeholder="Nemmer/phuonganh-tts-v2-lora-myvoice",
            ...
            gr.Markdown("""
            💡 **Sử dụng Custom Model:** Chọn "Custom Model" để tải LoRA adapter hoặc bất kỳ model nào được finetune từ **phuonganh-tts** hoặc **phuonganh-tts-0.3B**.
            """)
                ...
                with gr.Tabs() as tabs:
                    ...
                    with gr.TabItem("🦜 Voice Cloning", id="custom_mode") as tab_custom:
                        ...
                        **💡 Mẹo nhỏ:** Nếu kết quả Zero-shot Voice Cloning chưa như ý, bạn hãy cân nhắc **Finetune (LoRA)** để đạt chất lượng tốt nhất. 
                        Hướng dẫn chi tiết có tại file: `finetune/README.md` hoặc xem trên [GitHub](https://github.com/mvu696841111/PhuongAnh-TTS/tree/main/finetune).
                        """)              
        ...
        def on_custom_id_change(model_id):
            if model_id and "lora" in model_id.lower():
                if "0.3" in model_id:
                    base_model = "phuonganh-tts-0.3B (GPU)"
                else:
                    base_model = "phuonganh-tts (GPU)"
