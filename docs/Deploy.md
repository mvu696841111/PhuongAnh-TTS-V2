# 🐳 Docker Deployment Guide for phuonganh-tts
...
Copy `.env.example` to `.env` and set your image name (e.g., `myregistry.com/phuonganh-tts-gpu`):
...
*Note: The image is tagged `ghcr.io/mvu696841111/phuonganh-tts:serve` by default. Update the Makefile if you use a different registry.*
