...
def create_voices_json(audio_path, text, voice_name, output_path="voices.json", description="", append=False, set_default=True):
    ...
    if append and Path(output_path).exists():
        ...
        voices_data = {
            "meta": {
                "spec": "phuonganh.voice.presets",
                "spec_version": "1.0",
                "engine": "phuonganh-tts",
                "author": "Nemmer",
                "license": "CC BY-NC 4.0",
                "homepage": "https://github.com/mvu696841111/PhuongAnh-TTS",
    ...
    # Load DistillNeuCodec (same codec phuonganh-tts uses at inference)
