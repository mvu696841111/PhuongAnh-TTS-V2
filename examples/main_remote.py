"""
phuonganh-tts SDK Example: Remote Mode
Version: 1.1.6
"""
...
def main():
    ...
    # ---------------------------------------------------------
    # Remote mode is LIGHTWEIGHT: It doesn't load the heavy model locally.
    # It only loads a small Codec to encode/decode audio instantly.
